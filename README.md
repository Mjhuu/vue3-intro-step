...
> 基于vue3的系统步骤引导组件。
> 更加便捷的操作步骤引导。
> vue2版本的步骤引导组件请移步 [vue-intro-step](https://www.npmjs.com/package/vue-intro-step)


> [vue3-intro-step 求⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️⭐️](https://github.com/Mjhuu/vue3-intro-step)
...
> 
> `@close:show` 事件参数：关闭步骤引导组件时会触发的事件
